import{c as e,d as t,n,r,t as i}from"./app-CI1OQhEB.js";import{t as a}from"./DashboardLayout-BEP6e6kh.js";var o=t(e(),1),s=i();function c({course:e={},downloadHref:t=null}){let{title:i=`Kelas Offline`,instruktur:c=`Akan dikonfirmasi`,perusahaan:d=`Akan dikonfirmasi`,tanggal:f=`Akan dikonfirmasi`,jadwal:p=`Akan dikonfirmasi`,tempat:m=`Akan dikonfirmasi`,durasi:h=`Akan dikonfirmasi`}=e;return(0,o.useEffect)(()=>{let e=document.createElement(`style`);return e.innerHTML=`
            @media print {
                /* Hide sidebar */
                [data-testid="sidebar"],
                nav,
