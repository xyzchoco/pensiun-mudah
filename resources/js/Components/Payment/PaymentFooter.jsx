    ...
    <footer className="bg-[#F3F2F0] border-t border-[#E4E2E1] mt-12">
      <div className="mx-auto max-w-6xl px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {/* --- 1. TENTANG --- */}
          <div>
            <h3 className="font-bold text-[#008740] mb-4">Pensiun Mudah</h3>
            <p className="text-sm text-[#6B7280] leading-relaxed max-w-xs">
              Membimbing profesional berpengalaman menuju masa pensiun yang
              lebih bermakna, sehat, dan sejahtera melalui ekosistem belajar
              yang ramah senior.
            </p>
          </div>
          ...
          {/* --- 2. KONTAK --- */}
          <div>
            <h3 className="font-bold text-[#1B1C1C] mb-4">Kontak</h3>
          ...
          {/* --- 3. SOSIAL --- */}
          <div>
            <h3 className="font-bold text-[#1B1C1C] mb-4">Ikuti Kami</h3>
