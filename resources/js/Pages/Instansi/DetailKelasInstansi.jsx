...
export default function DetailKelasInstansi({
    ...
    const purchaseHref = `/instansi/pelatihan/${course?.slug || ''}/pembelian-online?qty=${qty}`;
    ...
    return (
        <InstansiLayout showSidebar={false} title={courseTitle + ' - Pensiun Mudah'} activeNav="dashboard">
                    ...
                    <div className="mt-6 grid gap-6 lg:grid-cols-3">
                        ...
                        <div className="rounded-2xl border-2 border-[#006B32] bg-white p-6 shadow-sm">
                            ...
                            <p className="text-sm text-[#9AA6A0]">
                                ...
                                <span className="ml-2 font-semibold text-[#006B32]">
                                    ({formattedUnitOriginalPrice} / org)
                                </span>
                            </p>
