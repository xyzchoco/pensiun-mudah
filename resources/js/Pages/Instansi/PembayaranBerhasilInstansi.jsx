...
export default function PembayaranBerhasilInstansi({
    course,
    transaction,
    voucher,
}) {
    ...
    const dashboardHref = '/instansi/dashboard';
    ...
    return (
        <InstansiLayout showSidebar={false} title="Pembayaran Berhasil - Pensiun Mudah" activeNav="dashboard">
