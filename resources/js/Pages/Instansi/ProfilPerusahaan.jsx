...
export default function ProfilPerusahaan() {
    ...
    const companyFields = [
        ...
        },
        {
            ...
            value: profile.kategori_bisnis || '-',
            highlight: false,
            span: 1,
        },
        {
            label: 'Email Bisnis',
            value: profile.email_bisnis || '-',
            highlight: false,
            link: true,
            span: 1,
        },
        ...
        },
        {
            ...
            value: profile.email_perusahaan || '-',
            highlight: false,
            span: 1,
        },
    ];
    ...
    return (
        <InstansiLayout
            ...
            activeNav="profil"
        >
            {/* Toast notifikasi sudah ditangani di InstansiLayout */}
            ...
            <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-10">
                ...
                <div className="mt-6 rounded-2xl border border-[#E4E2E1] bg-white p-6 shadow-sm sm:p-8">
                    ...
                    <div className="mt-8 flex flex-col gap-3 border-t border-[#E4E2E1] pt-6 sm:flex-row">
                        <Link
                            href="/instansi/profil-perusahaan/edit"
