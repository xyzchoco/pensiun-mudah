...
export default function PembayaranBerhasilKorporat({
    courseName = 'Manajemen Keuangan Masa Pensiun',
    licenseCount = 50,
    accessCode = 'PM-CORP-8829',
    registrationLink = 'https://pensiunmudah.id/join/corp-8829',
    dashboardHref = '/korporat/dashboard',
    invoiceHref = '#',
}) {
                ...
                <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-10">
                    <div className="text-center">
                        ...
                        <p className="mx-auto mt-3 max-w-xl text-[#3D4A3E]">
                            Transaksi Anda telah diproses dengan sukses. Kelas
                            kini tersedia untuk didistribusikan kepada karyawan
                            Anda.
                        </p>
                    </div>
                    ...
                    <div className="mt-10 grid gap-6 lg:grid-cols-2">
                        <div className="space-y-6">
                            <div className="rounded-2xl border border-[#E4E2E1] bg-white p-5 shadow-sm">
                                <div className="flex items-center gap-4">
                                    <div className="flex h-20 w-24 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-[#1B3326] to-[#0C1A12]">
                                        <svg
                                            className="h-8 w-8 text-[#9AE6B4]"
                                            fill="none"
                                            stroke="currentColor"
                                            strokeWidth="1.5"
                                            viewBox="0 0 24 24"
                                        >
                                            ...
                                            <path
                                                strokeLinecap="round"
                                                strokeLinejoin="round"
                                                d="M3 12l9 4.5 9-4.5M3 16.5L12 21l9-4.5"
                                            />
                                        </svg>
                                    </div>
                                    ...
                                    <div className="flex min-w-0 flex-1 items-center gap-2 rounded-lg border border-[#E4E2E1] bg-[#F6F3F2] px-3 py-2">
                                        ...
                                        >
                                            <path
                                                strokeLinecap="round"
                                                strokeLinejoin="round"
                                                d="M13.5 10.5a4 4 0 010 5.66l-2.5 2.5a4 4 0 01-5.66-5.66l1.5-1.5m5.66-1.5a4 4 0 000-5.66l2.5-2.5a4 4 0 015.66 5.66l-1.5 1.5"
                                            />
                                        </svg>
                                        <span className="truncate text-sm text-[#3D4A3E]">
                                            {registrationLink}
                                        </span>
                                    </div>
                                    <button
                                        type="button"
                                        onClick={() =>
                                            copyText(registrationLink, 'tautan')
                                        }
                                    ...
                                    >
                                        ...
                                        >
                                            <path
                                                strokeLinecap="round"
                                                strokeLinejoin="round"
                                                d="M8.7 10.7a4 4 0 015.66 0M15.3 13.3a4 4 0 01-5.66 0"
                                            />
                                            <path
                                                strokeLinecap="round"
                                                strokeLinejoin="round"
                        ...
                        <div className="space-y-6">
                                    ...
                                    {nextSteps.map((step) => (
                                        ...
                                        >
                                            ...
                                            <div>
                                                ...
                                                <p className="mt-0.5 text-sm text-[#3D4A3E]">
                                                    {step.desc}
                                                </p>
                                            </div>
                                        </li>
                            ...
                            <a
                                href={invoiceHref}
                                className="flex items-center justify-center gap-2 text-sm font-bold text-[#006B32] hover:underline"
                            >
                                <svg
                                    className="h-4 w-4"
                                    fill="none"
