...
export default function PelatihanDibeli({ purchasedCourses = [], backHref = '/korporat/dashboard' }) {
    return (
        <KorporatLayout
                ...
                <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                    {purchasedCourses.length > 0 ? (
                                ...
                                <div className="flex flex-1 flex-col p-5">
                                    ...
                                    <div className="mt-auto flex items-center justify-between">
                                        <span className="flex items-center gap-1.5 text-sm font-semibold text-[#6B7280]">
                                            ...
                                            {course.used_count} / {course.max_uses} Peserta
                                        </span>
                        ...
                        <div className="col-span-full rounded-2xl border-2 border-dashed border-[#E4E2E1] py-16 text-center">
                            <p className="text-lg font-bold text-[#1B1C1C]">Belum Ada Pelatihan</p>
                            <p className="mt-1 text-sm text-[#6B7280]">Perusahaan Anda belum memiliki riwayat pembelian pelatihan.</p>
                        </div>
                    )}
                </div>
            </div>
