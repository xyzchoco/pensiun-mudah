    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="event-details">
                <p><strong>Judul Event:</strong> {{ $webinar->judul }}</p>
                <p><strong>Tanggal:</strong> {{ \Carbon\Carbon::parse($webinar->tanggal)->locale('id')->isoFormat('D MMMM YYYY') }}</p>
                <p><strong>Waktu:</strong> {{ \Carbon\Carbon::parse($webinar->jam)->format('H:i') }} WIB</p>
                <p><strong>Jenis Event:</strong> {{ $webinar->jenis_event }}</p>
